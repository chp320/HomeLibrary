...
- **다음 차례: 9장 묶음 B (B-3 스크롤바 + 초성 인덱스 스크롤러). 사전 조사·미결정 2건은 아래 "묶음 B 착수 준비" 참조.**
- **모든 변경 push 완료(origin/main = HEAD `5115fab`). 미커밋 없음.**
...
- **#4** [backlog-d] D-9 비밀번호 초기화 / **#5** [backlog-d] D-10 회원증 바코드(🔴 보안·스키마 변경)
