...
fun BookEditScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            FormField(state.isbn, viewModel::onIsbnChange, stringResource(R.string.book_field_isbn), isbnErrorMessage(state.isbnError), KeyboardType.Number)
    ...
    state.duplicate?.let { dup ->
        AlertDialog(
            ...
            text = { Text(stringResource(R.string.book_dup_message, dup.title, dup.addQty)) },
            confirmButton = {
